...
Route::middleware(['auth'])->prefix('/admin')->group(function () {
    ...
    Route::get('sla/order/{orderby}/{order}', 'SlaController@index')->name('sla.order');
    ...
    Route::get('empresa/order/{orderby}/{order}', 'EmpresaController@index')->name('empresa.order');

    Route::resource('usuario', 'UsuarioController');
    Route::get('usuario/destroy2/{id}', 'UsuarioController@destroy')->name('usuario.destroy2');
    Route::get('usuario/order/{orderby}/{order}', 'UsuarioController@index')->name('usuario.order');
