...
@section('content')
    <form method="POST" action="{{route('sla.update',['sla' => $sla])}}">
        {{ method_field('PUT') }}
        {{ csrf_field() }}

        <div class="col-md-12">
            <label for="nome">Nome</label>
            <input class="form-control" type="text" name="nome" id="nome" placeholder="Nome da SLA"
                   value="{{$sla->nome}}" required>
            <br>
        </div>
        @if($agent->isMobile())
            <div class="col-md-12">
                ...
                <ul class="list-group lista-enviar">
                    @foreach($prioridadesAtuais as $prioridade)
            ...
            <div class="col-md-6">
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <ul data-toggle="popover" title="Aviso" data-content="" id="sortable1"
        ...
        <div class="col-md-12">
            ...
            <a class="btn btn-success" onclick="salvar()">Atualizar</a>
