                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                        ...
                                        <div class="col-md-6 sem-padding">
                                            ...
                                            @if(Auth::user()->tipo == User::TIPO_ADMIN)
                                                <div class="alert alert-danger">
                                                    <strong>Este técnico está solicitando fechamento!</strong>
                                                </div>
                                                @endif
                                                </p>
                                        </div>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        @if(Auth::user()->tipo == User::TIPO_ADMIN)
                                            <a href="{{route('chamado.negar-fechamento',array('id' => $chamado->id))}}"
                                               class="btn btn-primary">Negar</a>
                                            <button class="botao-trocar btn btn-{{$res}}">Finalizar</button>
                                        @endif
