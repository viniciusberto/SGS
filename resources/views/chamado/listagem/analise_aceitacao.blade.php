...
@section('content')
    ...
    @endphp
    <div class="row">
        <div class="col-md-12 table-responsive tabela-listagem">
            <div class="list-group">
                @foreach($chamados as $chamado)
                    ...
                    <div class="modal fade" id="modal-{{$chamado->id}}" tabindex="-1" role="dialog"
                        ...
                        'sts' => \App\Chamado::STATUS_ACEITO, 'id' => $chamado->id])}}" @endif>
                            {{csrf_field()}}
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="col-md-12 modal-body">
                                        ...
                                        <div class="col-md-6 sem-padding">
                                            ...
                                            <div class="alert alert-danger">
                                                <strong>Este técnico está solicitando aceitação!</strong>
                                            </div>
                                            @endif
                                            </p>
                                        </div>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        @if(Auth::user()->tipo == User::TIPO_ADMIN)
                                            <a href="{{route('chamado.negar',['id' => $chamado->id])}}"
                                               class="btn btn-primary">Negar</a>
                                            <button class="botao-trocar btn btn-{{$res}}">Permitir</button>
                                        @endif
